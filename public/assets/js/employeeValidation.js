function employeeValidation(){
    ...
    var employee_id_no = document.employee_form.employee_id_no;
    ...
    if(employee_id_no.value.length == " " || !employee_id_no.value.match(alphanumeric)   ){
        alertError("employee_id_no_error","employee_id_no field should not be empty and should be alphanumeric  *")
        employee_id_no.style.border = "1px solid red";
        employee_id_no.style.display = "inline-block";
          
    }
    else {
        alertError("employee_id_no_error"," ")
        employee_id_no.style.border = "none";
        employee_id_no_error = false; 
    };
    ...
    if((firstname_error || lastname_error || phone_number_error || email_error || address_error || national_id_no_error || employee_id_no_error || username_error || password_error )==true){
